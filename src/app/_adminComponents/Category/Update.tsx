...
export default function UpdateCategory() {
    const { updateCateId } = useParams<UpdateCategoryId>();
    const { data, isLoading, error } = useCategoryId(updateCateId);
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                if (status === 200) {
                    ...
                    router.push("/dashboard/category-managment")
                }
            } catch (error: any) {
                setLoading(false)
