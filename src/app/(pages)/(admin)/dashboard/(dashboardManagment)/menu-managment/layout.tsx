                    ...
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-1">
                        <NavToggle>
                            <ul className="flex flex-col md:flex-row md:space-x-6 mt-4 md:mt-0">
                                <li><Link href="/dashboard/menu-managment" className="block dark:text-white py-2 px-3 hover:text-red-300">كل الوجبات</Link></li>
                                <li><Link href="/dashboard/menu-managment/add" className="block dark:text-white py-2 px-3 hover:text-red-300">إضافة</Link></li>
                            </ul>
                        </NavToggle>
                    </div>
                </nav>
